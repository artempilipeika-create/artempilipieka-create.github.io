...
def test_3d_workspace_save_copy_2d_and_transfer_to_order(page,api,settings,admin_user):
    ...
    panel(page,'right')
    page.locator('#height').fill('900')
    panel(page,'right')
    page.locator('#depth').fill('500')
    ...
    panel(page,'left','projects')
    page.locator('#duplicate-project').click()
...
def test_3d_room_multiple_modules_transfer_one_order(page,api,settings,admin_user):
    ...
    panel(page,'right')
    page.locator('#room-width').fill('5200')
    panel(page,'right')
    page.locator('#room-depth').fill('3600')
    panel(page,'right')
    page.locator('#room-height').fill('2800')
    panel(page,'right')
    page.locator('#body-search').fill('QA621 PO')
    panel(page,'right')
    page.locator('#body-results button').first.click()
...
def test_3d_share_link_opens_read_only_viewer(page,api,settings,admin_user):
    ...
    page.locator('#tab-projects').click()
    panel(page,'left','projects')
    page.locator('#share-project').click()
...
def test_studio_real_database_roundtrip_preserves_template_and_dimensions(page,api,settings,admin_user,selector,module_type,width,height):
    ...
    panel(page,'right')
    page.locator('#height').fill(str(height))
    panel(page,'right')
